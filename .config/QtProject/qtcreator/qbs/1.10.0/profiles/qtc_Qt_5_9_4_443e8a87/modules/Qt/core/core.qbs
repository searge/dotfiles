...
Module {
    ...
    property stringList config: ["file_copies", "qmake_use", "qt", "warn_on", "release", "link_prl", "bitcode", "reduce_exports", "shallow_bundle", "no_qt_rpath", "app_bundle", "incremental", "global_init_link_order", "lib_version_first", "sdk", "clang_pch_style", "cross_compile", "debug", "static", "ios", "uikit", "mac", "darwin", "unix", "posix", "gcc", "clang", "llvm", "c++11"]
    property stringList qtConfig: ["debug_and_release", "release", "debug", "build_all", "c++11", "c++14", "c++1z", "concurrent", "no-pkg-config", "reduce_exports", "release_tools", "simulator_and_device", "static", "stl", "assimp", "properties", "animation", "textcodec", "big_codecs", "codecs", "textdate", "datestring", "doubleconversion", "filesystemiterator", "filesystemwatcher", "gestures", "itemmodel", "proxymodel", "identityproxymodel", "library", "mimetype", "statemachine", "regularexpression", "settings", "sharedmemory", "sortfilterproxymodel", "stringlistmodel", "systemsemaphore", "temporaryfile", "translation", "xmlstream", "xmlstreamreader", "xmlstreamwriter", "accessibility", "action", "opengles2", "clipboard", "colornames", "cssparser", "cursor", "desktopservices", "imageformat_xpm", "draganddrop", "opengl", "freetype", "imageformatplugin", "harfbuzz", "highdpiscaling", "ico", "im", "image_heuristic_mask", "image_text", "imageformat_bmp", "imageformat_jpeg", "imageformat_png", "imageformat_ppm", "imageformat_xbm", "movie", "pdf", "picture", "sessionmanager", "shortcut", "standarditemmodel", "systemtrayicon", "tabletevent", "texthtmlparser", "textodfwriter", "validator", "whatsthis", "wheelevent", "avfoundation", "openal", "networkinterface", "bearermanagement", "ftp", "getaddrinfo", "getifaddrs", "http", "ipv6ifname", "localserver", "networkdiskcache", "networkproxy", "socks5", "ssl", "udpsocket", "groupbox", "buttongroup", "menu", "lineedit", "spinbox", "slider", "scrollbar", "scrollarea", "itemviews", "tableview", "toolbutton", "calendarwidget", "colordialog", "listview", "columnview", "combobox", "completer", "contextmenu", "datawidgetmapper", "datetimeedit", "dial", "filesystemmodel", "dirmodel", "resizehandler", "mainwindow", "dockwidget", "textedit", "errormessage", "splitter", "stackedwidget", "treeview", "filedialog", "fontcombobox", "fontdialog", "fscompleter", "graphicsview", "graphicseffect", "inputdialog", "keysequenceedit", "lcdnumber", "listwidget", "mdiarea", "menubar", "messagebox", "paint_debug", "progressbar", "progressdialog", "rubberband", "sizegrip", "splashscreen", "statusbar", "statustip", "style-stylesheet", "syntaxhighlighter", "tabbar", "tablewidget", "tabwidget", "textbrowser", "toolbar", "toolbox", "tooltip", "treewidget", "undocommand", "undostack", "undogroup", "undoview", "wizard", "dom"]
    property path binPath: "/Users/searge/Qt/5.9.4/ios/bin"
    property path incPath: "/Users/searge/Qt/5.9.4/ios/include"
    property path libPath: "/Users/searge/Qt/5.9.4/ios/lib"
    property path pluginPath: "/Users/searge/Qt/5.9.4/ios/plugins"
    property string mkspecName: "macx-ios-clang"
    property path mkspecPath: "/Users/searge/Qt/5.9.4/ios/mkspecs/macx-ios-clang"
    ...
    property path docPath: "/Users/searge/Qt/Docs/Qt-5.9.4"
    ...
    property stringList staticLibsDebug: ["z", "m", "m", "z", "qtpcre2_debug"]
    property stringList staticLibsRelease: ["z", "m", "m", "z", "qtpcre2"]
    ...
    property string libFilePathDebug: "/Users/searge/Qt/5.9.4/ios/lib/libQt5Core_debug.a"
    property string libFilePathRelease: "/Users/searge/Qt/5.9.4/ios/lib/libQt5Core.a"
    property string libFilePath: qtBuildVariant === "debug"
                                      ? libFilePathDebug : libFilePathRelease

    coreLibPaths: ["/Users/searge/Qt/5.9.4/ios/lib", "/Users/searge/Qt/5.9.4/ios/lib"]
    ...
    cpp.includePaths: {
        var paths = ["/Users/searge/Qt/5.9.4/ios/include", "/Users/searge/Qt/5.9.4/ios/include/QtCore"];
